...
Command: npx gltfjsx@6.5.3 ../../public/models/TeatroXicohtencatl.glb ./ 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/TeatroXicohtencatl.glb')
  return (
...
useGLTF.preload('/TeatroXicohtencatl.glb')
